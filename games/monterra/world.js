...
export function makeWorld(){
 ...
 for(let i=0;i<22;i++){const a=i/22*Math.PI*2,r=47+random()*6,x=Math.cos(a)*r,z=Math.sin(a)*r;b.add('cone',[x,2,z],[5+random()*5,5+random()*9,5+random()*5],i%2?'#6e8e87':'#87a39a');}
