...
export function freshState(family=0){return {version:3,team:[member(family)],active:0,orbs:12,potions:5,badges:[],wins:0,catches:0,position:{x:0,z:8},started:true,muted:false,steps:0};}
export function normalize(raw){
 ...
 base.badges=[...new Set(Array.isArray(raw.badges)?raw.badges.filter(x=>Number.isInteger(x)&&x>=0&&x<3):[])];base.muted=raw.muted===true;
